...
describe('Voting', () => {
  ...
  it('renders just the winner when there is one', () => {
    ...
    expect(winner.textContent).to.contain('Trainspoting');
  });
  ...
  it('renders as a pure component', () => {
    ...
    expect(firstButton.textContent).to.equal('Trainspoting');
  ...
  it('does update DOM when prop changes', () => {
    const pair = List.of('Trainspoting', '28 Days Later');
    const container = document.createElement('div');
    let component = ReactDOM.render(
      <Voting pair={pair} />,
      container
